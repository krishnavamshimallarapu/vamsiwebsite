...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"Training",
			"GenericItem",
			org.training.core.jalo.Training.class,
			"de.hybris.platform.persistence.trainingcore_Training",
			false,
			null,
			false
		);
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_Training_code();
			
				single_createattr_Training_Name();
			
				single_createattr_Training_Desig();
	...
	public void single_createattr_Training_code() throws JaloBusinessException
	{
	...
	public void single_createattr_Training_Name() throws JaloBusinessException
	{
	...
	public void single_createattr_Training_Desig() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createEnumerationValues(
			...
			single_setAttributeProperties_Training_code();
		
			single_setAttributeProperties_Training_Name();
		
			single_setAttributeProperties_Training_Desig();
			...
			single_setAttributeProperties_ElectronicsColorVariantProduct_color();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_Training_code() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_Training_Name() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_Training_Desig() throws JaloBusinessException
						{
